...
class Leagues {
    ...
    static let premiershipLeague: LeagueModel = LeagueModel(name: "Premiership", image: UIImage(named: "england")!)
    ...
    static let ligaLeague: LeagueModel = LeagueModel(name: "Liga", image: UIImage(named: "saudi contest")!)
